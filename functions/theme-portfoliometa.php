...
$meta_box_info = array(
	...
	'fields' => array(
	array(
			'name' =>  __('Descripción del proyecto', 'framework'),
	...
	array(
			'name' =>  __('Metros', 'framework'),
			'desc' => '',
			'id' => $prefix.'portfolio_surface',
			'type' => 'text',
			'std' => ''
		),
	array(
			'name' =>  __('Ubicación', 'framework'),
			'desc' => '',
			'id' => $prefix.'portfolio_loc',
			'type' => 'text',
			'std' => ''
		),	
	array(
			'name' =>  __('Etapa', 'framework'),
			'desc' => '',
			'id' => $prefix.'portfolio_etapa',
			'type' => 'text',
			'std' => ''
		),	
	),

...
function tz_create_post_type_portfolio() 
{
	$labels = array(
	  ...
	  $args = array(
		...
		'hierarchical' => false,
		'menu_position' => 5,
		"rewrite" => array('slug' => 'proyectos', 'hierarchical' => true),
...
function tz_build_taxonomies(){
	$args = array(
		"hierarchical" => true, 
		"label" => __( "Tipologías" ), 
		"singular_label" => __( "Tipología" ), 
		"rewrite" => array('slug' => 'tipologia', 'hierarchical' => true), 
		"public" => true
	);
...
function build_taxonomies() {  
	...
	register_taxonomy( 'colaboradores', 'portfolio', 
		array( 
			'hierarchical' => true, 
			'label' => 'Colaboradores', 
			'query_var' => true, 

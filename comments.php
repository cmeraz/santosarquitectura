...
/*-----------------------------------------------------------------------------------*/
		...
		<h3 id="comments">
            ...
            <span><?php echo stripslashes(get_option('tz_comment_caption')); ?></span>
        </h3>
		
		<ol class="commentlist">
        <?php wp_list_comments('type=comment&avatar_size=40&callback=tz_comment'); ?>
        </ol>
...
/*-----------------------------------------------------------------------------------*/
		...
		<?php if (is_single()) { ?><p class="nocomments"><?php _e('', 'framework') ?></p><?php } ?>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond">
		...
		<h3 id="respond-title">
            ...
            <span><?php echo stripslashes(get_option('tz_respond_caption')); ?></span>
        </h3>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<label for="author"><?php _e('Name', 'framework') ?> <small><?php if ($req) _e("*", 'framework'); ?></small></label></p>
		
			<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" />
			<label for="email"><?php _e('Email', 'framework') ?> <small><?php if ($req) _e("*", 'framework'); ?></small> <span><?php _e('(never published)', 'framework') ?></span></label></p>
			...
			<p><button name="submit" type="submit" id="submit" tabindex="5"><span class="icon"><span class="arrow"></span></span><?php _e('Submit Comment', 'framework') ?></button>

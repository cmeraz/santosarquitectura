...
<?php get_header(); ?>
			...
			<!--BEGIN #primary .hfeed-->
			<div id="primary-sketches" class="hfeed">
				
                <!--BEGIN #masonry-->
            	<div id="masonry-sketches">
                
                	<?php 
					
					$post_count = 0; 

					$empty = 'data-empty="'.__('No hay más entradas disponibles.', 'framework').'" ';
                    ...
                    <?php 
                    	//Show Sketches Category in the loop
                    	query_posts("cat=42"); 	
                    ?>

	...
	function tz_fancybox() {
		if(jQuery().fancybox) {
			jQuery("a.lightbox").fancybox({
				...
				'speedOut'		:	300, 
				'overlayShow'	:	true,
				'autoScale'		:	true, //custom
				'titleShow'		: 	true, //custom
				'margin'		: 	10
			});
		}
	}
...
/*-----------------------------------------------------------------------------------*/
/*	Contact SiderBar Script
/*-----------------------------------------------------------------------------------*/

$('#fclick').click(function(e){
	$('#show-contacto').slideToggle('slow');
	$('#show-contacto strong').css('color', 'black');
	e.preventDefault();
});

$('#f1ca9ad910e66').mouseenter(function(){
	$('.fb_iframe_widget').animate({
		width: "100%"
	}, 800);
});


$('#f1ca9ad910e66').mouseleave(function(){
	$('.fb_iframe_widget').animate({
		with: "52px;"
	}, 800);
});

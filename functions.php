...
/*-----------------------------------------------------------------------------------*/
/*	Add custom post type to the Rigth Now Widget
/*-----------------------------------------------------------------------------------*/

//Ad all custom post types to the Right Now Box on the Dashborad
add_action('right_now_content_table_end', 'right_now_custom_posttypes');

function right_now_custom_posttypes(){
	...
	foreach( $post_type as $post_type ) {
		...
		$num_post = wp_count_posts( $post_type->name );
